...
angular.module('myApp.controllers', [])
  ...
  $scope.NumberIsClicked = function(obj) {
	  ...
	  if ($scope.NextElementIndex+1 == $scope.SortedArray.length  )
	     { 
		  winSound = new Media("/android_asset/www/app/sounds/finish.mp3");
		  winSound.play();
		  ...
		  console.log("you win ") ; 
		   ...
		   if (obj ==  $scope.SortedArray[$scope.NextElementIndex] )  
			   ...
			   console.log("  ok  ") ; 
			   okSound = new Media("/android_asset/www/app/sounds/ok_button.mp3");
			   okSound.play();
	    	   ...
	    	   wrongSound = new Media("/android_asset/www/app/sounds/wrong_button.mp3");
	    	   wrongSound.play();
	  			}
	  		}
  ...
  .controller('MyCtrl2', ['$scope', '$document',  function($scope, $document) {
      ...
      myMedia = new Media("/android_asset/www/app/sounds/ok_button.mp3");
      myMedia.play();
